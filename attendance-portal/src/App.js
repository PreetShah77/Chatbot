...
const handleClick = () => {
  ...
  let imageData = canvas.toDataURL('image/png');
    ...
    postData('http://localhost:80/rest-api/run-face-check', {
      image: base64Image,status:'Entry',
    })
    .then(response => {
  ...
  return (
    <AppStyles>
      <Navbar bg="dark" expand="lg" variant="dark">
        <Navbar.Brand href="#">
          <img src="logo.png" alt="Company Logo" height="70" />
        </Navbar.Brand>
        ...
        <Row>
          <Col xs={12} md={6}>
            <div className="camera-container">
              ...
              <Button className="btn btn-primary mt-3" onClick={handleClick}>Entry</Button>
